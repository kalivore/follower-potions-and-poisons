...
function IdentifyPotionAsync(bool waitForAny, string asActorName, Potion akPotion, Keyword[] akEffectKeywords, int[] akRestoreEffects, int[] akFortifyEffectsStats, int[] akFortifyEffectsWarrior, int[] akFortifyEffectsMage, int[] akResistEffects)
    if (!thread01.Queued())
        thread01.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread02.Queued())
        thread02.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread03.Queued())
        thread03.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread04.Queued())
        thread04.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread05.Queued())
        thread05.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread06.Queued())
        thread06.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread07.Queued())
        thread07.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread08.Queued())
        thread08.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread09.Queued())
        thread09.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread10.Queued())
        thread10.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread11.Queued())
        thread11.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread12.Queued())
        thread12.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread13.Queued())
        thread13.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread14.Queued())
        thread14.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread15.Queued())
        thread15.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread16.Queued())
        thread16.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread17.Queued())
        thread17.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread18.Queued())
        thread18.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread19.Queued())
        thread19.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    elseif (!thread20.Queued())
        thread20.GetAsync(asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
    else
        ...
        if (waitForAny)
			...
			WaitAll()
		endIf
        IdentifyPotionAsync(waitForAny, asActorName, akPotion, akEffectKeywords, akRestoreEffects, akFortifyEffectsStats, akFortifyEffectsWarrior, akFortifyEffectsMage, akResistEffects)
	endif
endFunction
